                ...
                [ 
                    {
                        ...
                        opcode: 'setPenStyle', blockType: Scratch.BlockType.COMMAND, text: 'Set fill color to r: [r] g: [g] b: [b] a: [a]', arguments: {
                            "r": {
                        ...
                        opcode: 'setOutlineColor', blockType: Scratch.BlockType.COMMAND, text: 'Set outline color to r: [r] g: [g] b: [b] a: [a]', arguments: 
                        {
                            "r": {
...
// logArrays 
            opcode: "log",  
                blockType: Scratch.BlockType.COMMAND, text: "logArrays", 
            }, {
...
console.log("QArrays extension loaded");
