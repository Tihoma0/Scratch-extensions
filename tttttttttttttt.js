...
// safe reference const stageCanvas = runtime.renderer.canvas;
...
//xx, xy 0, overlay.height / 360, 
// yx, yy overlay.width / 2, 
//xoffset overlay.height / 2 
//yoffset );
                 this.forceRedraw();
...
// clear opcode: 'clear', blockType: Scratch.BlockType.COMMAND, text:"Clear Overlay", 
                }, {
                     
// set fill opcode: 'setFillColor', blockType: Scratch.BlockType.COMMAND, text: 'Set fill color to r: [r] g: [g] b: [b] a: [a]', arguments: {
                         "r": {
...
// set stroke opcode: 'setStrokeColor', blockType: Scratch.BlockType.COMMAND, text: 'Set outline color to r: [r] g: [g] b: [b] a: [a]', arguments: {
                         "r": {
...
// set line width opcode: 'setLineWidth', blockType: Scratch.BlockType.COMMAND, text: 'Set line width to [width]', arguments: {
                         "width": {
...
// fill rect opcode: 'fillRect', blockType: Scratch.BlockType.COMMAND, text: 'Fill Rect x: [x] y: [y] w: [width] h: [height]', arguments: {
                         "x": {
                            "type": Scratch.ArgumentType.NUMBER, "defaultValue": 0
                        }, "y": {
                            "type": Scratch.ArgumentType.NUMBER, "defaultValue": 0
...
// draw rect opcode: 'drawRect', blockType: Scratch.BlockType.COMMAND, text: 'Draw Rect x: [x] y: [y] w: [width] h: [height]', arguments: {
                         "x": {
                            "type": Scratch.ArgumentType.NUMBER, "defaultValue": 0
                        }, "y": {
                            "type": Scratch.ArgumentType.NUMBER, "defaultValue": 0
...
// fill circle opcode: 'fillCircle', blockType: Scratch.BlockType.COMMAND, text: 'Fill Circle x: [x] y: [y] radius: [radius]', arguments: {
                         "x": {
                            "type": Scratch.ArgumentType.NUMBER, "defaultValue": 0
                        }, "y": {
                            "type": Scratch.ArgumentType.NUMBER, "defaultValue": 0
...
// circle opcode: 'drawCircle', blockType: Scratch.BlockType.COMMAND, text: 'Draw Circle x: [x] y: [y] radius: [radius]', arguments: {
                         "x": {
                            "type": Scratch.ArgumentType.NUMBER, "defaultValue": 0
                        }, "y": {
                            "type": Scratch.ArgumentType.NUMBER, "defaultValue": 0
...
// fill oval opcode: 'fillOval', blockType: Scratch.BlockType.COMMAND, text: 'Fill Oval x: [x] y: [y] w: [width] h: [height]', arguments: {
                         "x": {
                            "type": Scratch.ArgumentType.NUMBER, "defaultValue": 0
                        }, "y": {
                            "type": Scratch.ArgumentType.NUMBER, "defaultValue": 0
...
// draw oval opcode: 'drawOval', blockType: Scratch.BlockType.COMMAND, text: 'Draw Oval x: [x] y: [y] w: [width] h: [height]', arguments: {
                         "x": {
                            "type": Scratch.ArgumentType.NUMBER, "defaultValue": 0
                        }, "y": {
                            "type": Scratch.ArgumentType.NUMBER, "defaultValue": 0
...
// line opcode: 'drawLine', blockType: Scratch.BlockType.COMMAND, text: 'Draw Line x1: [x1] y1: [y1] x2: [x2] y2: [y2]', arguments: {
                         "x1": {
                            "type": Scratch.ArgumentType.NUMBER, "defaultValue": 0
                        }, "y1": {
                            "type": Scratch.ArgumentType.NUMBER, "defaultValue": 0
...
// text opcode: 'fillText', blockType: Scratch.BlockType.COMMAND, text: 'Draw Text [text] x: [x] y: [y] size: [size] font: [font]', arguments: {
                         "text": {
...
// outline text opcode: 'outlineText', blockType: Scratch.BlockType.COMMAND, text: 'Outline Text [text] x: [x] y: [y] size: [size] font: [font]', arguments: {
                         "text": {
                            "type": Scratch.ArgumentType.STRING, "defaultValue": "Hello World"
                        }, "x": {
                            "type": Scratch.ArgumentType.NUMBER, "defaultValue": 0
             ...
             this.currentPenstyle.fillStyle = rgba(${
                args.r
            }, ${
                args.g
            }, ${
             ...
             this.currentPenstyle.strokeStyle = rgba(${
                args.r
            }, ${
                args.g
            }, ${
     ...
     if (!Scratch.extensions.unsandboxed) {
         ...
         constructor(gl, vertexShaderSrc, fragmentShaderSrc, source) {
             ...
             if (loc === null) {
                 console.error(Could not find uniform ${
                    name
                } in shader);
...
// init webGLOverlay opcode: 'initWebGLOverlay', blockType: Scratch.BlockType.COMMAND, text: 'Init WebGLOverlay', 
                }, {
                     
// is WebGLOverlay initialized? opcode: 'isWebGLOverlayInitialized', blockType: Scratch.BlockType.BOOLEAN, text: 'Is WebGLOverlay initialized?', 
                }, {
...
// Wtf stupid f*cking scratch 
             ...
             switch (args.type) {
                 ...
                 break;
                 default: throw new Error(Invalid gl type: ${
                    args.type
                });
                 
            } const target = this.webgloverlay.GL[args.target];
             const usage = this.webgloverlay.GL[args.usage];
             if (!target || !usage) throw new Error(Invalid gl target or usage: ${
                args.target
            }, ${
                args.usage
            });
     ...
     class QArrayInspector {
         constructor() {
             ...
             for (const name of this.displayElements.keys()) {
                 if (!names.has(name)) {
                     this.displayElements.get(name).remove();
                     this.displayElements.delete(name);
                     
                } 
            } for (const [name, array] of qArrays.entries()) {
                 if (this.displayElements.has(name)) {
                     const [qArrayDisplay, ValueDisplay, nameDisplay] = this.displayElements.get(name) const text = ${
                        JSON.stringify(array)
                    };
                     if (text.startsWith(""ERROR:")) { qArrayDisplay.setAttribute('class', 'qArrayDisplayerror'); } ValueDisplay.textContent = ${text}; nameDisplay.textContent = ${name}; } else { this.addQArrayDisplay(array, name); } } } addQArrayDisplay(qArray, name = null) { const qArrayDisplay = document.createElement('div'); qArrayDisplay.setAttribute('class', 'qArrayDisplay'); const nameDisplay = document.createElement('div'); nameDisplay.setAttribute('class', 'nameDisplay'); const ValueDisplay = document.createElement('div'); ValueDisplay.setAttribute('class', 'ValueDisplay'); const text = ${JSON.stringify(qArray)}; if (text.startsWith(""ERROR:")) {
...
// createQArray opcode: "createQArray", blockType: Scratch.BlockType.COMMAND, text: "create QArray [NAME]", arguments: {
                                 NAME: {
...
// createQArrayFromJSArray opcode: "createQArrayFromJSArray", blockType: Scratch.BlockType.COMMAND, text: "create QArray [NAME] from JSArray [ARRAY]", arguments: {
                                 NAME: {
                                     type: Scratch.ArgumentType.STRING, defaultValue: "myArray" 
                                }, ARRAY: {
                                     type: Scratch.ArgumentType.STRING, defaultValue: "[]" 
...
// deleteQArray opcode: "deleteQArray", blockType: Scratch.BlockType.COMMAND, text: "delete QArray [NAME]", arguments: {
                                 NAME: {
                                     type: Scratch.ArgumentType.STRING, defaultValue: "myArray" 
                                }, 
                            } 
...
// pushQArray opcode: "pushQArray", blockType: Scratch.BlockType.COMMAND, text: "push [VALUE] to QArray [NAME], should cast: [SHOULDCAST]", arguments: {
                                 VALUE: {
                                     type: Scratch.ArgumentType.STRING, defaultValue: "myArray" 
                                }, NAME: {
                                     type: Scratch.ArgumentType.STRING, defaultValue: "myArray" 
...
// popQArray opcode: "popQArray", blockType: Scratch.BlockType.REPORTER, text: "pop QArray [NAME]", arguments: {
                                 NAME: {
                                     type: Scratch.ArgumentType.STRING, defaultValue: "myArray" 
                                }, 
                            } 
...
// clearQArray opcode: "clearQArray", blockType: Scratch.BlockType.COMMAND, text: "clear QArray [NAME]", arguments: {
                                 NAME: {
                                     type: Scratch.ArgumentType.STRING, defaultValue: "myArray" 
                                }, 
                            } 
...
// copyQArraytoQarray opcode: "copyQArraytoQarray", blockType: Scratch.BlockType.COMMAND, text: "copy QArray [NAME] to QArray [NAME2]", arguments: {
                                 NAME1: {
                                     type: Scratch.ArgumentType.STRING, defaultValue: "myArray" 
                                }, NAME2: {
...
// sortQArray opcode: "sortQArray", blockType: Scratch.BlockType.COMMAND, text: "sort QArray [NAME]", arguments: {
                                 NAME: {
                                     type: Scratch.ArgumentType.STRING, defaultValue: "myArray" 
                                }, 
                            } 
...
// reverseQArray opcode: "reverseQArray", blockType: Scratch.BlockType.COMMAND, text: "reverse QArray [NAME]", arguments: {
                                 NAME: {
                                     type: Scratch.ArgumentType.STRING, defaultValue: "myArray" 
                                }, 
                            } 
...
// logArrays opcode: "log", blockType: Scratch.BlockType.COMMAND, text: "logArrays", 
                        }, {
                             
// copyToScratchList opcode: "copyToScratchList", blockType: Scratch.BlockType.COMMAND, text: "copy QArray [NAME] to Scratch List named [NAME2]", arguments: {
                                 NAME: {
                                     type: Scratch.ArgumentType.STRING, defaultValue: "myArray" 
                                }, NAME2: {
...
// copyFromScratchList opcode: "copyFromScratchList", blockType: Scratch.BlockType.COMMAND, text: "copy Scratch List named [NAME] to QArray [NAME2]", arguments: {
                                 NAME: {
                                     type: Scratch.ArgumentType.STRING, defaultValue: "myList" 
                                }, NAME2: {
                                     type: Scratch.ArgumentType.STRING, defaultValue: "myArray" 
...
// showQArrays opcode: "showQArrays", blockType: Scratch.BlockType.COMMAND, text: "show QArrays", 
                        }, {
                             
// hideQArrays opcode: "hideQArrays", blockType: Scratch.BlockType.COMMAND, text: "hide QArrays", 
                        }, ], menus: {
                             dtypes: {
                    ...
                    } if (!this.QArrays.has(args.NAME)) return "error: QArray " + args.NAME + " does not exist";
                     this.QArrays.get(args.NAME).push(args.VALUE);
                     
                } popQArray(args, util) {
                     const arr = this.QArrays.get(args.NAME);
                     console.log(args.NAME, arr);
                     if (!arr) return "ERROR: QArray " + args.NAME + " does not exist";
                     ...
                     if (!list) {
                         console.warn(List "${args.NAME2}" not found);
                         return;
                         
                    } console.log(this.QArrays.get(args.NAME));
                    ...
                    } this.QArrays.set(args.NAME2, list.value);
                     
                } showQArrays(args, util) {
                     if (!this.QArrayInspector) {
                         this.QArrayInspector = new QArrayInspector() requestAnimationFrame(() => this.updateQArrayInspector());
...
// 20fps this.QArrayInspector.update(this.QArrays);
